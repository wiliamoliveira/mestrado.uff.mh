...
public class PathRelinkingForOLD implements PathRelinkingStrategy {
	private Heuristic heuristic;

	public PathRelinkingForOLD(Heuristic heuristic) {
